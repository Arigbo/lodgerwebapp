                ...
                <div className="search_page_dp">
                    <div className="search_page_dp_header">
                        ...
                        <div className="search_page_dp_header_middle">
                            <form className="search_page_dp_header_middle_search">
                                ...
                                <input type="text" name="search" id="search" placeholder="Search For an Apartment" onChange={handleChange} />
                            </form>
                    ...
                    <div className="search_page_dp_inner">
                        ...
                        <div className="search_page_dp_inner_results">
                            <div className="search_page_dp_inner_results_filter">
                                  <div>
                                      <i className="fas fa-location-pin"></i>
                                    <select name="Select the package" id="" title="select">
                                        <option value=""><span>Location</span></option>
                                        <option value="">Simple Bottle</option>
                                        <option value="">Simple Bottle</option>
                                    </select>
                                  </div>
                                  <div>
                                    ...
                                    <select name="Select the package" id="" title="select">
                                        <option value=""><span>Select Price range better for you</span></option>
                                        <option value="">Simple Bottle</option>
                                        <option value="">Simple Bottle</option>
                                    </select>
                                  </div>
                                 <div>
                                    ...
                                    <select name="Select the package" id="" title="select">
                                        <option value=""><span>Apartment Type</span></option>
                                        <option value="">Simple Bottle</option>
                                        <option value="">Simple Bottle</option>
                                    </select>
                                 </div>
                                 ...
                                 <i className="fas fa-users"></i>
                                    <select name="" id="" title="Select">
                                        <option value=""><span>Persons</span></option>
                                        <option value="">Simple Bottle</option>
                                        <option value="">Simple Bottle</option>
                                    </select>
                                 </div>
                            </div>
                            <div className="search_page_dp_inner_results_inner">
                                {product.map(item => (
                                    <div className={item.availableRooms == 0 ? "none" : "search_page_dp_inner_results_inner_result"} key={item.id}>
                                        <div className="search_page_dp_inner_results_inner_result_inner">
                                            <div className="search_page_dp_inner_results_inner_result_inner_img">
                                                <img src={item.frontyard} alt="mmm" />
                                            </div>
                                            <Link href={`/blogs/${item.id}`} >
                                                <div className="search_page_dp_inner_results_inner_result_inner_info">
                                                    <h1 className={item.ban == true ? "banded" : "none"}>Baned</h1>
                                                    <div className={item.ban == ! true ? "search_page_dp_inner_results_inner_result_inner_info_inner" : "none"}>
                                                        <h1 className="price">${item.price}</h1>
                                                        <h1 className="location"><i className="fas fa-location-pin"></i>{item.houseNo} {item.streetName} {item.state}</h1>
                                                        <div className="search_page_dp_inner_results_inner_result_inner_info_inner_x-details">
                                                            <h1 className="ar" title="Available Rooms">AR: {item.availableRooms}</h1>
